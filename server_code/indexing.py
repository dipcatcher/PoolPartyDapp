...
def check_pool(chain, address):
  ...
  w3=getw3(chain)
  contract = w3.eth.contract(address=contract_address, abi=contract_abi)
  data = {"RELOAD_PHASE_START":contract.RELOAD_PHASE_START().call(),
          "RELOAD_PHASE_END":contract.RELOAD_PHASE_END().call(),
          "STAKE_START_DAY":contract.STAKE_START_DAY().call(),
          "STAKE_END_DAY":contract.STAKE_END_DAY().call(), 
